  ...
  return (
    <div className="bg-transparent">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-6 md:mb-8 leading-[1.1] tracking-tight px-2">
              See How We Transform <span className="text-primary-400">Service Business Websites</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 font-light leading-relaxed max-w-3xl mx-auto px-2">
              Demonstration projects showing our approach to building lead-generating websites that actually generate revenue.
            </p>
          </div>
        </div>
      </section>
      ...
      <FinalCTASection
        ...
        subtitle="Let's discuss how we can help your service business get more phone calls, more booked jobs, and more revenue."
      />
    </div>
  );
}
