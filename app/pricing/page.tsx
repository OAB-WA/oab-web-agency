      ...
      <Section className="py-24 md:py-32 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <SectionHeader
            ...
            subtitle="Most agencies lock you into expensive monthly contracts. If you stop paying, you lose your website. With OAB, you own everything."
          />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="bg-neutral-50 rounded-[2.5rem] p-8 md:p-12 border border-neutral-100">
              ...
              <div className="mt-12 pt-8 border-t border-neutral-200">
                <p className="text-sm uppercase tracking-widest text-neutral-400 font-bold mb-3">Cost Breakdown:</p>
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    <span className="text-neutral-500">Year 1:</span>
                    <span className="text-gray-900 font-semibold">$3,600</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-neutral-500">Year 2:</span>
                    <span className="text-gray-900 font-semibold">$3,600</span>
                  </div>
                </div>
                <div className="pt-3 border-t border-neutral-200">
                  <p className="text-sm uppercase tracking-widest text-neutral-400 font-bold mb-2">Total after 2 Years:</p>
            ...
            <div className="bg-primary-950 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl transform md:scale-105 z-10">
              ...
              <div className="mt-12 pt-8 border-t border-white/10">
                <p className="text-sm uppercase tracking-widest text-white/40 font-bold mb-3">Cost Breakdown:</p>
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                ...
                <div className="pt-3 border-t border-white/10">
                  <p className="text-sm uppercase tracking-widest text-white/40 font-bold mb-2">Total after 2 Years:</p>
                  <p className="text-3xl font-bold text-white">$2,400</p>
                  <p className="text-emerald-400 text-sm mt-2 font-bold italic">You save $4,800+ vs rental agencies</p>
                </div>
              </div>
            </div>
          </div>
